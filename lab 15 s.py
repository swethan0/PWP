...
# Updated Student records for Swethan
my_record = [
    (93400133171, 'Swethan', 'PWP', 98),
    (93400133171, 'Swethan', 'ICE', 95),
    (93400133171, 'Swethan', 'DMGT', 92),
    (93400133171, 'Swethan', 'DSC', 89),
    (93400133171, 'Swethan', 'SS', 86),
    (93400133171, 'Swethan', 'COA', 84)
]
...
cursor.execute('''
    UPDATE my_record 
    SET Mark = 98 
    WHERE Enrollment = 93400133171 AND Subject = 'COA'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 93400133171 AND Subject = 'SS'
''')
conn.commit()
